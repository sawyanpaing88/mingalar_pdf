...
# ==========================================
# 🏠 DASHBOARD ENGINE (WITH NARROWED & COLORED CHARTS)
# ==========================================
if page_selection == "🏠 Dashboard Console":
    ...
    if not df_quotes.empty:
        ...
        # Split layout into 4 columns to visually compress/narrow down chart footprints
    ...
    if action_c2.button("🖨️ Compile Official Corporate PDF Engine Asset"):
        ...
        <head>
            ...
            <style>
                ...
                .address-text {{ font-size: 8pt; color: #4b5563; text-align: right; line-height: 1.4; width: 60%; }}
